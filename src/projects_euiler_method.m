...
for i = 2 : length(t)
    ...
    y2(i) = y2(i-1) + h*f2(mA,mB,lA,lB,g,y1(i-1),y2(i-1),y3(i-1),y4(i-1));
    y4(i) = y4(i-1) + h*f4(mA,mB,lA,lB,g,y1(i-1),y2(i-1),y3(i-1),y4(i-1));
end
...
%     y3(i) = y3(i-1) + h*y4(i-1);
% 
%     u2(i) = y2(i-1) + h*f2(mA,mB,rA,rB,g,y1(i-1),y2(i-1),y3(i-1),y4(i-1));
%     u4(i) = y4(i-1) + h*f4(mA,mB,rA,rB,g,y1(i-1),y2(i-1),y3(i-1),y4(i-1));
% 
%     y2(i) = y2(i-1) +...
%    0.5*h*( f2(mA,mB,rA,rB,g,y1(i-1),y2(i-1),y3(i-1),y4(i-1)) + f2(mA,mB,rA,rB,g,y1(i),u2(i),y3(i),u4(i)) );
%     y4(i) = y4(i-1) +...
%    0.5*h*( f4(mA,mB,rA,rB,g,y1(i-1),y2(i-1),y3(i-1),y4(i-1)) + f4(mA,mB,rA,rB,g,y1(i),u2(i),y3(i),u4(i)) );
% end
